...
import { otpBypass } from "./otp-bypass";
    ...
    emailOTP({
      async sendVerificationOTP({ email, otp, type }) {
        ...
        await resend.emails.send({
          from: fromEmail,
          to: email,
          subject: `[Jodi Crypto Scanner] Verification Token: ${otp}`,
          html: `
            <div style="background-color: #0b0e11; color: #eaecef; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 40px 20px; max-width: 550px; margin: 0 auto; border-radius: 8px; border: 1px solid #2b2f36;">
              <div style="text-align: center; margin-bottom: 30px; border-bottom: 1px solid #2b2f36; padding-bottom: 20px;">
                <h1 style="color: #2f81f7; font-size: 22px; font-weight: 800; margin: 0; letter-spacing: 1px;">JODI CRYPTO<span style="color: #848e9c; font-weight: 400;">SCANNER</span></h1>
              ...
              <div style="padding: 0 10px;">
                ...
                <div style="text-align: center; margin: 35px 0;">
                  ...
                  <div style="font-size: 36px; font-weight: 800; letter-spacing: 8px; color: #2f81f7; background: #181a20; padding: 16px 28px; border-radius: 6px; display: inline-block; border: 1px solid #2b2f36; font-family: monospace;">
                    ${otp}
                  </div>
                </div>
                
                <div style="background: rgba(47, 129, 247, 0.04); border-left: 3px solid #2f81f7; padding: 12px 16px; border-radius: 0 4px 4px 0; margin-bottom: 25px;">
                  <p style="font-size: 12px; line-height: 1.5; color: #2f81f7; margin: 0; font-weight: 500;">
